(function (Sinco) {
    ...
    var iconos = {
        ...
        Warning: function (dim, bgColor) {
            ...
            var _path = ce('path');
            _path.attr('d', 'm17.74999,29.49997l-5.74999,0l0,-5.74999l5.74999,0l0,5.74999zm0,-11.49998l-5.74999,0l0,-17.24997l5.74999,0l0,17.24997z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor;
            _svg.appendChild(_path);
        ...
        Mas: function (dim, bgColor) {
            ...
            _svg.attr('viewBox', '0 0 16 16');

            var _g = ce('g');

            var _path = ce('path');

            _path.attr('d', 'm4,7l0,2l3,0l0,3l2,0l0,-3l3,0l0,-2l-3,0l0,-3l-2,0l0,3l-3,0zm4,9c-4.41828,0 -8,-3.58172 -8,-8c0,-4.41828 3.58172,-8 8,-8c4.41828,0 8,3.58172 8,8c0,4.41828 -3.58172,8 -8,8zm0,0');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _g.appendChild(_path);
        ...
        Calendario: function(dim){
            ...
            _text.attr('y', 18);
            _text.attr('text-anchor', 'middle');
            _text.appendChild(document.createTextNode(new Date().getDate()));
            _svg.appendChild(_text);
        ...
        Flecha: function (dim, bgColor) {
            ...
            var _svg = ce('svg');
            _svg.attr('width', dim);
            _svg.attr('height', (dim * 434) / 363);

            _svg.attr('viewBox', '0 0 363 434');

            var _path = ce('path');

            _path.attr('d', 'm147.39321,181.3458l-98.32687,98.3189l0,-86.75803l130.5,-129.77399l130.5,129.77399l-0.54026,85.67753l-98.5096,-97.96139l0,194.11928l-63.62327,0l0,-193.39629z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
        ...
        Perfil: function (dim, bgColor) {
            ...
            var _svg = ce('svg');
            _svg.attr('width', dim);
            _svg.attr('height', (dim * 380) / 455);

            _svg.attr('viewBox', '0 0 455 380');
        ...
        Lapiz: function (dim, bgColor) {
            ...
            _path.attr('d', 'm0,14.2l0,3.8l3.8,0l11,-11.1l-3.8,-3.8l-11,11.1l0,0zm17.7,-10.2c0.4,-0.4 0.4,-1 0,-1.4l-2.3,-2.3c-0.4,-0.4 -1,-0.4 -1.4,0l-1.8,1.8l3.8,3.8l1.7,-1.9l0,0z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
        ...
        Telefono: function (dim, bgColor) {
            ...
            _path.attr('d', 'M3.6,7.8 C5,10.6 7.4,12.9 10.2,14.4 L12.4,12.2 C12.7,11.9 13.1,11.8 13.4,12 C14.5,12.4 15.7,12.6 17,12.6 C17.6,12.6 18,13 18,13.6 L18,17 C18,17.6 17.6,18 17,18 C7.6,18 0,10.4 0,1 C0,0.4 0.4,0 1,0 L4.5,0 C5.1,0 5.5,0.4 5.5,1 C5.5,2.2 5.7,3.4 6.1,4.6 C6.2,4.9 6.1,5.3 5.9,5.6 L3.6,7.8 L3.6,7.8 Z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
        ...
        Pintura: function (dim, bgColor) {
            ...
            _path.attr('d', 'm7.09606,2.98252l2.46894,4.48774l-9.43999,9.45437l12.29918,11.95038l10.16579,-9.95865l3.63055,-0.76601l-17.13273,-17.15956l-1.99173,1.99173zm12.26974,13.94211l-13.71019,0l6.85547,-6.8551l6.85472,6.8551z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
            ...
            _path.attr('d', 'm26.22052,18.15035c0,0 -3.78018,4.11908 -3.78005,6.1748c0,2.05571 1.69247,3.72223 3.77999,3.72211c2.08808,0.00012 3.78055,-1.66633 3.78049,-3.72211c0.00006,-2.05571 -3.78043,-6.1748 -3.78043,-6.1748z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
        ...
        Microsoft: function (dim, bgColor) {
            ...
            _path.attr('d', 'm0.3275,16.86768l7.80771,1.13085l0,-7.46999l-7.80771,0l0,6.33914zm0,-7.40623l7.80771,0l0,-7.47078l-7.80771,1.13085l0,6.33993zm8.8748,8.69177l10.47641,1.51738l0,-9.14206l-10.47641,0l0,7.62468zm0,-16.31763l0,7.62586l10.47641,0l0,-9.14245l-10.47641,1.51659z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
        ...
        Facebook: function (dim, bgColor) {
            ...
            _svg.attr('viewBox', '0 0 56.693 56.693');

            var _path = ce('path');

            _path.attr('d', 'M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
        ...
        Instagram: function (dim, bgColor) {
            ...
            _path.attr('d', 'M28.2,16.7c-7,0-12.8,5.7-12.8,12.8s5.7,12.8,12.8,12.8S41,36.5,41,29.5S35.2,16.7,28.2,16.7z M28.2,37.7 c-4.5,0-8.2-3.7-8.2-8.2s3.7-8.2,8.2-8.2s8.2,3.7,8.2,8.2S32.7,37.7,28.2,37.7z');
            _path.style.strokeWidth = 0;
            _path.style.fill = bgColor || '#1B344C';
            _svg.appendChild(_path);
